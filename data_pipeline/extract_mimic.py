"""Build data/mimic_all_filtered.csv from the MIMIC-IV Clinical Database Demo.

Requires a local copy of the MIMIC-IV demo (PhysioNet, not redistributed here).
Override the location with:
    export MIMIC_IV_DEMO_DIR=/path/to/mimic-iv-clinical-database-demo-2.2
See data/README.md.
"""
import pandas as pd
import os
...
base_path = os.environ.get(
    "MIMIC_IV_DEMO_DIR",
    str(REPO_ROOT / "data" / "mimic-iv-clinical-database-demo-2.2"),
)
output_path = str(REPO_ROOT / "data" / "mimic_all_filtered.csv")
